...
class _SICodes:
    ...
    TAG_OBJ_LIST_OFFSET          = 0x0703
    TAG_OBJ_LIST_LIMIT           = 0x0704
    TAG_OBJ_EXPRESSION           = 0x0705
    TAG_OBJ_CRITERION            = 0x0706
    TAG_OBJ_CRIT_PROPERTY        = 0x0707
    TAG_OBJ_CRIT_VALUE           = 0x0708
    TAG_OBJ_PROPERTY             = 0x0709
    TAG_OBJ_VALUE                = 0x070A
    TAG_OBJ_ARRAY                = 0x070B
    TAG_OBJ_TYPE                 = 0x070C
